...
const planDefs = [
  {
    ...
    features: [
      ...
      { text: 'Auto-scan every 6h', on: true },
      { text: 'Manual scan every 15min', on: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Auto-scan every 2h', on: true },
      { text: 'Manual scan every 5min', on: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Auto-scan every 1h', on: true },
      { text: 'Manual scan every 2min', on: true },
      { text: 'Slack & Discord alerts', on: true },
      { text: 'Competitor tracking', on: true },
